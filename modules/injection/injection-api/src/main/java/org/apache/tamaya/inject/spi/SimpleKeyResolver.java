...
/**
 * Key resolver, which evaluates the keys to {@code Owner.class.getSimpleName() + '.' + propertyKey}.
 */
public final class SimpleKeyResolver implements KeyResolver {
    ...
    private String getSectionName(Member member) {
        if(member instanceof Field){
            ...
            return f.getDeclaringClass().getSimpleName();
