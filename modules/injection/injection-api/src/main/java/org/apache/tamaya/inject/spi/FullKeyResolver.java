...
/**
 * Key resolver, which evaluates the keys to {@code Owner.class.getName() + '.' + propertyKey}.
 */
public final class FullKeyResolver implements KeyResolver {
