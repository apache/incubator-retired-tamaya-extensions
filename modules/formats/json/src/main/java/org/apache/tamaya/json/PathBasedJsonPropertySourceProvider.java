 ...
 */
public class PathBasedJsonPropertySourceProvider extends AbstractPathPropertySourceProvider{

    private static final Logger LOG = Logger.getLogger(PathBasedJsonPropertySourceProvider.class.getName());
